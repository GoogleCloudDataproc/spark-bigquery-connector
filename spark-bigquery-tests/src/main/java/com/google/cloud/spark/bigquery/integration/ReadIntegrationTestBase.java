...
//   }
//   */
//   test("read data types. DataSource %s".format("bigquery")) {
...
//
  ...
  public void testKnownSizeInBytes() {
    ...
    long actualTableSize = allTypesTable.queryExecution().analyzed().stats().sizeInBytes()
        .longValue();
