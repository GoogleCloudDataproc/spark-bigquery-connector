...
| version | Link |
| --- | --- |
| Scala 2.11 | `gs://spark-lib/bigquery/spark-bigquery-with-dependencies_2.11-0.22.1.jar` ([HTTP link](https://storage.googleapis.com/spark-lib/bigquery/spark-bigquery-with-dependencies_2.11-0.22.1.jar)) |
| Scala 2.12 | `gs://spark-lib/bigquery/spark-bigquery-with-dependencies_2.12-0.22.1.jar` ([HTTP link](https://storage.googleapis.com/spark-lib/bigquery/spark-bigquery-with-dependencies_2.12-0.22.1.jar)) |
...
| --- | --- |
| Scala 2.11 | `com.google.cloud.spark:spark-bigquery-with-dependencies_2.11:0.22.1` |
| Scala 2.12 | `com.google.cloud.spark:spark-bigquery-with-dependencies_2.12:0.22.1` |
...
pyspark --jars gs://spark-lib/bigquery/spark-bigquery-with-dependencies_2.11-0.22.1.jar
  --py-files gs://spark-lib/bigquery/spark-bigquery-support-0.22.1.zip
  --files gs://spark-lib/bigquery/spark-bigquery-support-0.22.1.zip
```
...
spark = SparkSession.builder\
  .appName('BigNumeric')\
  .config('spark.jars', 'gs://spark-lib/bigquery/spark-bigquery-with-dependencies_2.11-0.22.1.jar')\
  .config('spark.submit.pyFiles', 'gs://spark-lib/bigquery/spark-bigquery-support-0.22.1.zip')\
  .config('spark.files', 'gs://spark-lib/bigquery/spark-bigquery-support-0.22.1.zip')\
  .getOrCreate()
```
...
spark.sparkContext.addPyFile("gs://spark-lib/bigquery/spark-bigquery-support-0.22.1.zip")
```
...
from pyspark.sql import SparkSession
spark = SparkSession.builder\
  .config("spark.jars.packages", "com.google.cloud.spark:spark-bigquery-with-dependencies_2.11:0.22.1")\
  .getOrCreate()
...
com.google.cloud.spark:spark-bigquery-with-dependencies_**2.12**:0.22.1. In
...
```sbt
libraryDependencies += "com.google.cloud.spark" %% "spark-bigquery-with-dependencies" % "0.22.1"
```
