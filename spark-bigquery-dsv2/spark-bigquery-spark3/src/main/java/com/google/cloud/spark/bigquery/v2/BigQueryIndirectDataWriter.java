...
class BigQueryIndirectDataWriter extends GenericBigQueryIndirectDataWriter implements DataWriter<InternalRow> {
    ...
    protected BigQueryIndirectDataWriter(
            int partitionId, Path path, FileSystem fs, StructType sparkSchema, Schema avroSchema,
            IntermediateRecordWriter intermediateRecordWriter){
    ...
    public void write(InternalRow record) throws IOException {
        GenericRecord avroRecord = AvroSchemaConverter.sparkRowToAvroGenericData(record,sparkSchema,getAvroSchema());
