...
public class Spark32BigQueryTable extends Spark31BigQueryTable {
  ...
  public static Spark32BigQueryTable fromConfigurationAndSchema(
      Injector injector, StructType sparkProvidedSchema) {
    SparkBigQueryConfig config = injector.getInstance(SparkBigQueryConfig.class);
    return Spark3Util.createBigQueryTableInstance(
        Spark32BigQueryTable.class, injector, config.getTableId(), sparkProvidedSchema);
  }

  public static Spark32BigQueryTable fromIdentifier(Injector injector, Identifier ident) {
    BigQueryClient bigQueryClient = injector.getInstance(BigQueryClient.class);
    return Spark3Util.createBigQueryTableInstance(
        Spark32BigQueryTable.class,
        injector,
