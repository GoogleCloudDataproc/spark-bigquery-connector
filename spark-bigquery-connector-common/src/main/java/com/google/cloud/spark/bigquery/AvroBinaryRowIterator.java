...
public class AvroBinaryRowIterator implements Iterator<Row> {

  private static final Logger log = LoggerFactory.getLogger(AvroBinaryRowIterator.class);
  ...
  public Row next() {
    try {
      return (Row)
          SchemaConverters.convertToInternalRow(
