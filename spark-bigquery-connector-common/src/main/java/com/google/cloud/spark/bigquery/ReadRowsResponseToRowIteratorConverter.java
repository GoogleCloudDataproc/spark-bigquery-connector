...
public interface ReadRowsResponseToRowIteratorConverter {

  static ReadRowsResponseToRowIteratorConverter avro(
  ...
  static ReadRowsResponseToRowIteratorConverter arrow(
      final List<String> columnsInOrder,
  ...
  Iterator<Row> convert(ReadRowsResponse response);

  class Avro implements ReadRowsResponseToRowIteratorConverter, Serializable {
    ...
    @Override
    public Iterator<Row> convert(ReadRowsResponse response) {
      return new AvroBinaryRowIterator(
          bqSchema,
          columnsInOrder,
  ...
  class Arrow implements ReadRowsResponseToRowIteratorConverter, Serializable {
    ...
    @Override
    public Iterator<Row> convert(ReadRowsResponse response) {
      return new ArrowBinaryRowIterator(
          columnsInOrder,
          arrowSchema,
