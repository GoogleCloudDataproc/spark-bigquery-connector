...
public class BigQueryInputPartitionReaderTest {
    ...
    private static final Schema ALL_TYPES_TABLE_BIGQUERY_SCHEMA = Schema.of(
            ...
            Field.of("record_f", LegacySQLTypeName.RECORD,
                    Field.of("s", LegacySQLTypeName.STRING),  Field.of("i", LegacySQLTypeName.INTEGER)),
            Field.of("null_f", LegacySQLTypeName.STRING),
            Field.newBuilder("sarray_f", LegacySQLTypeName.STRING).setMode(Field.Mode.REPEATED).build(),
            Field.newBuilder("iarray_f", LegacySQLTypeName.INTEGER).setMode(Field.Mode.REPEATED).build());
    private static final ImmutableList<String> ALL_TYPES_TABLE_FIELDS = ImmutableList.of(
            "string_f", "bytes_f", "int_f", "float_f", "numeric_f", "boolean_f", "timestamp_f", "date_f",
            "time_f", "datetime_f", "geo_f", "record_f", "null_f", "sarray_f", "iarray_f"
    );
    ...
    private TableInfo allTypesTableInfo() {
        return TableInfo.newBuilder(
                ...
                StandardTableDefinition.newBuilder().setType(TableDefinition.Type.TABLE)
