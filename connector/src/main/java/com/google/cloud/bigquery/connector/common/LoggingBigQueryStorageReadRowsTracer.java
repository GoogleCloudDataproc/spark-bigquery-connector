...
public class LoggingBigQueryStorageReadRowsTracer implements BigQueryStorageReadRowsTracer {
    ...
    private void logData() {
        log.info("{}: Started: {} Ended: {} Parse Timings: {}  Time in Spark: {} Time waiting for service: {} ", streamName, startTime,
                endTime == null ? "" : endTime.toString(), format(parseTime),
                format(sparkTime), format(serviceTime));
        linesLogged++;
    }
